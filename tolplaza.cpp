...
int toll::insertf()
{
    ...
    ofstream fout;
    fout.open("tollplaza.dat",ios::app|ios::binary);
...
void toll::show()
{
 ...
 void toll::srch(char *t){
 	int re=0;
 	ifstream fin;
 	fin.open("tollplaza.dat",ios::in|ios::binary);
 	if(!fin)
 	cout<<"NOT FOUND !!!!!"<<endl;
 	else{
...
{      system("color 2");
    ...
    //---------------------------------------------------------------------------------------------
    do{
            cout<<endl<<"   1. NEW ENTRY."<<endl<<endl<<"   2. SEARCH ENTRY."<<endl<<endl<<"   3. SHOW ALL ENTRIES."<<endl<<endl<<"   4. NO OF CARS PASSED AND TOTAL AMOUNT."<<endl<<endl<<"   5. EXIT."<<endl<<endl<<"   6. CLEAR FILE."<<endl<<endl<<">>>";
            cin>>i;
            system("cls");
            cout<<endl<<endl<<"                        TOLL PLAZA SYSTEM"<<endl;
    cout<<"   --------------------------------------------------------------"<<endl;
    ...
    cout<<"-----------------HAVE A NICE DAY----------------- "<<endl;
            ...
            break;
            case 4:
            cout<<"TOTAL AMOUNT UPTO NOW  |  "<<Count<<" VEHICLES         :Rs. "<<sum<<endl<<endl;
            break;
            case 2:
            	char xyz[20];
				cout<<"ENTER CAR NUMBER : ";
